...
class NewListTest(TestCase):
    def test_can_save_a_POST_request(self):                                         # HTTP POST Request submits data to be processed to a specified resource
        self.client.post('/lists/new', data={'text': 'A new list item'})       # to do a POST, call self.client.post: 'data' argument contains the form data we want to send
    ...
    def test_redirects_after_POST(self):
        response = self.client.post('/lists/new', data={'text': 'A new list item'})    # to do a POST, call self.client.post: 'data' argument contains the form data we want to send
